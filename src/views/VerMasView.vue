        ...
        <div class="row px-4">
            ...
            <div class="col-12 py-4">
                <button v-for="tag in post.tags" :key="tag" @click="filtrar(tag)"
                    class="btn btn-sm btn-outline-primary mb-1">{{ tag }}</button>
            </div>
            ...
            <div class="col-12 py-4">
                <div class="btn-group btn-group-lg w-100">
                    ...
                    <button @click="cambiarPost('anterior')" type="button" class="btn btn-outline-primary"><i
                            class="fa fa-angle-left mr-2"></i> Anterior</button>
            ...
            <div class="col-12 py-4">
                ...
                <div v-for="coment in post.comentarios" :key="coment" class="media mb-4">
                    <img src="/Eu.png" alt="Image" class="mr-3 mt-1 rounded-circle" style="width:60px;">
...
export default {
    setup() {
        ...
        const cambiarPost = async (param) => { // param puede ser anterior o siguiente
            try {
